        ...
        <MainLayout>
            <div className="hotel-cart">
                <div className="cart-link">
                    <Container>
                        <span><span><Link to="/">Home</Link> / <Link to="/Hotels">Hotels</Link> /</span> Cart</span>
                    </Container>
                </div>
                                                ...
                                                <Row className="row-full-height">
                                                    ...
                                                    <Col xl={3} lg={3} md={3} xs={6} className="quantity">
                                                        <div>
                                                            ...
                                                            <Input type="number" value={item.adult + item.children} />
                                                        </div>
                                                    </Col>
                                                        ...
                                                        <div className="price-pay">
                                                            ...
                                                            <span className="scale-total">
                                                                $ {calculationTotalItem(
                                                                    item.price, item.buffet, item.priceOfBuffet
                                                                )}
                                                            </span>
                                                        </div>
