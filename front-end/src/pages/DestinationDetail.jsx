                        ...
                        <Row>
                            <Col xl={4} lg={4} md={5} xs={12} className="destination-detail-main-sidebar">
                                ...
                                <div className="popular-hotel-in-here mt-30 mb-50">
                                    <p className="title">Popular hotels in {destination && destination.title}</p>
                            ...
                            <Col xl={8} lg={8} md={7} xs={12} className="destination-detail-main-content">
                                <Row className="header">
                                    <Col xl={8} lg={8} md={12} xs={12} className="header-left">
                                        <p className="title">{destination && destination.title}</p>
                                        <p className="location">{destination && destination.address}</p>
                                    </Col>
                                    <Col xl={4} lg={4} md={12} xs={12} className="header-right">
                                        <div className="rate-stars">
                                            <div className="stars-counter">
                                                <span className="stars-number-calculation">
                                                    {reviews && reviews.length > 0 ? starsCounter(ratingCalculation(reviews)) : starsCounter(0)}
                                                </span>
                                                <span className="stars-number">
                                                    <span>
                                                        {reviews && reviews.length > 0 ? ratingCalculation(reviews) : 0}
                                                    </span>
                                ...
                                <CarouselSlide image={destination && destination.image} />

                                <div className="description">
                                    <p dangerouslySetInnerHTML={{__html: destination ? destination.description : ''}}></p>
                                </div>
